...
set parametric; plot [-1.047198:-0.523599] 0.000000+cos(t)*2.000000,0.000000+sin(t)*2.000000 w l lc'black' lw 2 notitle;unset parametric
set parametric; plot [-0.523599:0.000000] 0.000000+cos(t)*2.000000,0.000000+sin(t)*2.000000 w l lc'black' lw 2 notitle;unset parametric
...
set parametric; plot [0.000000:1.047198] 0.000000+cos(t)*1.000000,0.000000+sin(t)*1.000000 w l lc'black' lw 2 notitle;unset parametric
...
set parametric; plot [1.047198:2.094395] 0.000000+cos(t)*1.000000,0.000000+sin(t)*1.000000 w l lc'black' lw 2 notitle;unset parametric
set arrow from 0.000000,2.000000 to -0.520945,2.954423 nohead lc'black' lw 2
...
set arrow from -1.732051,1.000000 to -2.298133,1.928363 nohead lc'black' lw 2
...
set arrow from -1.000000,0.000000 to -1.732051,-1.000000 nohead lc'black' lw 2
set arrow from -1.732051,-1.000000 to -2.819078,-1.026060 nohead lc'black' lw 2
set parametric; plot [3.665191:4.188790] 0.000000+cos(t)*2.000000,0.000000+sin(t)*2.000000 w l lc'black' lw 2 notitle;unset parametric
plot 1/0 notitle
unset multiplot
set output
